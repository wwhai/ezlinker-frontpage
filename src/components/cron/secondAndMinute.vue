<!-- 秒,分钟 -->
<template lang="html">
  <div class='list second-min-list' :val="value_">
    <div class='item'>
    ...
    <div class='item'>
      ...
      <el-checkbox-group v-model="appoint">
        <div  v-for="i in 6" :key="i" style="margin-left: 10px; line-height: 25px;">
          ...
          <el-checkbox style='margin: 0;width: 50px;' @change="type = '4'"  v-for="j in 10" :key="j" :label="(i - 1) + '' + (j - 1)"></el-checkbox>
        </div>
      </el-checkbox-group>
    </div>
  </div>
