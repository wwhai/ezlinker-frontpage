<template lang="html" >
  <div :val="value_" class='list month-list'>
    <div class='item'>
    ...
    <div class='item'>
      ...
      <span>从</span>
      <el-input-number @change="type = '2'" v-model="cycle.start" :min="1" 
      :max="12" size="mini" style="width: 100px;"></el-input-number>
      <span>至</span>
      <el-input-number @change="type = '2'" v-model="cycle.end" :min="2" 
      :max="12" size="mini" style="width: 100px;"></el-input-number>
      月
    </div>
    <div class='item'>
