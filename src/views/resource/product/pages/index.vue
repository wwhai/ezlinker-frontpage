...
<d2-container class="product-container" v-loading="product.loading">
    ...
    <div class="list-box">
        ...
        <div class="list-head">
            ...
            <div class="right">
                ...
                <span class="input-box">
                    <el-input placeholder="搜索产品" v-model="product.key" class="input-with-select" size="small">
        ...
        <div class="list-body">
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            <div class="tool">
                                ...
                                <span>
                                    <router-link class="design-btn" :to="{path:'/product/'+scope.row.id+'/detail'}">
                                        详情
                                    </router-link>
                                </span>
                                <!-- <span>
            ...
            <!-- 产品分页 -->
            <el-pagination v-if="product.total>product.size" class="product-page" layout="prev, pager, next" :page-size="product.size" :total="product.total"></el-pagination>
        </div>
    </div>
    <!-- 编辑产品弹窗 -->
