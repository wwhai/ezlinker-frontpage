...
<template>
  <d2-container class="project-container">
    <el-card class="box-card">
      ...
      <!-- ------- -->
      <!-- 数据表格 -->
      <el-table stripe :data="deviceRecords.tableData" border  height = "600px" height="700px">
...
1. 表格
```html
<el-table border :data="cloudfuncPage.data" height = "600px">
...
```html
 <el-pagination
          ...
          :current-page.sync="XXX.current"
          :page-size="XXX.size"
          :total="XXX.total"
          @current-change="XXXPagenation">
</el-pagination>
